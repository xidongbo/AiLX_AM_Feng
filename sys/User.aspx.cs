...
public partial class User : System.Web.UI.Page
{
    ...
    {
        String sql = "select c_id,c_login,c_na,c_dept,c_cc,c_email,c_role,c_arrange from t_users where c_login<>'admin' and c_system='" + du_tools.gcs_sytem + "'";
    ...
    {
        Response.Redirect("addUser.aspx?c_id=");
    }
    ...
    protected void edit_click(object sender, EventArgs e)
    {
        ...
        Response.Write("window.location.href('AddUser.aspx?c_id=" + str + "');");
    ...
    {
        string str = ((Button)sender).CommandArgument.ToString();
        SQLHelper.ExecuteNonQuery("delete from t_users where c_id=" + str);
        BindGrid();
    }
